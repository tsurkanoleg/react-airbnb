  ...
  const data = {
	...
	return (
		<Page> 
			...
			<Description title="Про сусідів" children={data.neighborhood_info} />   {/* "Опис" і "Про сусідів"  це 2 варіанти як написати. Працюють однаково */}
			...
			<Additional
				...
				registration={data.additional_properties.registration}
			/>
